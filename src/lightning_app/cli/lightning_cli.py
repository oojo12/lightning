...
from lightning_app.core.constants import get_lightning_cloud_url, LOCAL_LAUNCH_ADMIN_VIEW, APP_SERVER_URL
...
def get_app_url(runtime_type: RuntimeType, *args) -> str:
    if runtime_type == RuntimeType.CLOUD:
        ...
        if LOCAL_LAUNCH_ADMIN_VIEW:
            return APP_SERVER_URL + '/admin'
        else:
            return APP_SERVER_URL + '/view'
